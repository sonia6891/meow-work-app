const CACHE_NAME='meow-work-pwa-v218';
const STATIC_ASSETS=['./index.html','./privacy.html','./terms.html','./support.html','./manifest.webmanifest?v=218','./assets/welcome-brand-v112.webp','./assets/mobile-hero-clean-v75.png','./assets/mobile-rest-card-v75.webp','./assets/meow-assistant-pro-v169.webp?v=209','./workcat-home-v12.png','./app-icon-v178-180.png?v=209','./app-icon-v178-192.png?v=209','./app-icon-v178-512.png?v=209','./splash-v183.jpg?v=209'];
